  ...
  return (
    <div className="flex flex-col items-center justify-center py-10 h-full bg-secondary w-full mt-20 gap-3 relative">
      ...
      <div className="flex gap-2 items-center justify-center">
        <Link href="https://www.instagram.com/adaptivedesigns" 
         target="_blank"
        >
          {" "}
          <AiOutlineInstagram
        ...
        <Link href="https://www.linkedin.com/company/adaptivedesigns" target="_blank">
          {" "}
          <FaLinkedinIn style={{ fontSize: "1rem", color: "#fff" }} />{" "}
        </Link>
        <Link href="https://www.facebook.com/adaptivedesigns" target="_blank">
          {" "}
          <GrFacebookOption style={{ fontSize: "1rem", color: "#fff" }} />{" "}
        </Link>
        <Link href="https://t.me/adaptivedesigns" target="_blank">
          {" "}
