  ...
  const officeData = [
    {
      ...
      description: `The client company is involved in the import and distribution of medical and sanitary supplies. The idea of the space is to incorporate the company’s brand colors with white, earth tones, and greenery in a modern and dynamic way.
...
`,
    ...
    {
      title: "SUWEYS ",
      description: `The client came to us to design their 400m2 space which had a ground and a mezzanine level. The ground level is a showroom for TVS three-wheelers and had a large storefront glass wall. The mezzanine level was intended as an office space for the company.
...
`,
    ...
    },
    {
      ...
      description: `The office was on an old 60-year-old building and there were structural and bureaucratic limits to how much freedom we had in renovating it. We were able to come up with a very modern clean and efficient design that is within the limitations but still elegant.
...
`,
      image: [
        ...
        "/Portfolio/Interior/Office/3/2.jpg",
        "/Portfolio/Interior/Office/3/3.jpg",
        "/Portfolio/Interior/Office/3/4.jpg",
        "/Portfolio/Interior/Office/3/5.jpg",
        "/Portfolio/Interior/Office/3/6.jpg",
        "/Portfolio/Interior/Office/3/7.jpg",
        "/Portfolio/Interior/Office/3/8.jpg",
        "/Portfolio/Interior/Office/3/9.jpg",
        "/Portfolio/Interior/Office/3/10.jpg",
      ],
    },
    {
      title: "AIE",
      description: `A modern conference room that can host up to 30 people
...
`,
    ...
    {
      title: "Mite ",
      description: `A mix of modern and industrial concepts is used. The bright red color is tastefully used on the counters used for cashiers and also storekeepers. The bold design of the counter is inspired by car spare parts and it is reflected in the intrusion and extrusion.
...
`,
    ...
    },
    {
      ...
      description: `The very high room height is further exaggerated by the use of bold deep arches on the walls.
...
`,
    ...
    },
    {
      ...
      description: `This design was done for a franchise pharmacy company meaning the design had to be standardized. The modular sales counters give the flexibility to be used both in large and small franchise spaces. We just increase and decrease the number of modules according to the size of spaces available.
...
`,
    ...
    },
    {
      ...
      description: `This is a small café with a serving area that is 15m2 (3m*5m). There is an additional 8m2 kitchen at the backside. There was a limited amount of seating and the space was dark and old.
...
`,
    ...
    },
    {
      ...
      description: `The large restaurant is designed in an industrial style. The exposed metal trusses are painted black. And it has hanging pendant lights on it.
The ceiling is finished in light oak with a mix of white gypsum board. The white, the wood, and the black create a natural balance in the space together with the parquet flooring.
Plenty of natural light floods the space the windows all around the walls. The light bouncing on the glossy table tops and the floors gives the space a modern character.
The outdoor seating area has a retractable roof. The space is protected from the harsh sun and at night the roof opens up to unleash the outdoor vibe.
`,
...
The use of mirrors on ceilings and walls gives the space depth and another dimension.
  ...
  const residentialData = [
    {
      ...
      description: `The apartment entryway is decorated using UV boards and wood-textured panels. Protrusion and intrusion of the two types of claddings are accented by LED strip lights as well as scone wall lights.
...
`,
    ...
    },
    {
      ...
      description: `The unique thing about the space is that it contains both a modern-style living room but also an Arabian-style seating area. The two spaces are zoned separately by the two different ceiling designs used accordingly. They are also visually broken up using a wooden privacy screen which doubles as a bookshelf.
...
`,
    ...
    },
    {
      ...
      description: `Selectively antique motifs that are lavish but not loud.
...
`,
    ...
    },
    {
      ...
      description: `As soon as you enter you are greeted by a double-story entryway covered in high-rising marble and warm oak textured louvers. The low-hanging modern led pendant illuminates the space in a soft warm light.
