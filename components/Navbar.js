...
export default function Navbar() {
  ...
  return (
    <div className="w-[100vw] bg-primary shadow-md h-[3rem] flex sm:justify-between xs:justify-between flex-row sticky top-0 z-50 overflow-y-visible md:pl-11 sm:pl-4 xs:pl-4 sm:w-[100vw] xs:w-[100vw] z-50">
      ...
      <div className="flex w-full justify-end items-center sm:hidden xs:hidden md:flex">
