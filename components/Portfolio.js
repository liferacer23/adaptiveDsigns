          ...
          <div className="h-full lg:w-[50%] xs:w-[100%] sm:w-[100%] flex flex-col">
            <div className="h-[50%] w-full flex">
              <div className="relative h-full w-[50%]">
                <div className=" absolute p-4 flex items-center justify-center h-full w-full opacity-0 hover:opacity-100 bg-black  cursor-pointer transition-all duration-1000">
                  <span className="text-xl">Portfolio 2</span>
                </div>
                <div className=" h-full w-full  bg-[url('../public/coffee.webp')] cursor-pointer bg-cover transition-all duration-1000 hover:hidden"></div>
              </div>
              <div className="relative h-full w-[50%]">
                <div className=" absolute p-4 flex items-center justify-center h-full w-full opacity-0 hover:opacity-100 bg-black  cursor-pointer transition-all duration-1000">
